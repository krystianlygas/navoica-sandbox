...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ElementViewing", function() { return ElementViewing; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ViewedEventTracker", function() { return ViewedEventTracker; });
...
var ViewedEventTracker = function () {
   ...
   */
  function ViewedEventTracker(elements, viewedAfterMs) {
    var _this2 = this;
    ...
    elements.forEach(function (el) {
      _this2.elementViewings.add(new ElementViewing(el, viewedAfterMs, function (element, event) {
        return _this2.callHandlers(element, event);
      }));
    });
...
//# sourceMappingURL=ViewedEvent.js.map